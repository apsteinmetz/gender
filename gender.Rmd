...
```
Women contribute to the top R packages at more than twice the rate of top Python packages.  Can we speculate as to a reason?  R is data science and Python is includes more CS.  With both languages, more than 90% of the contributors are men.  Clearly, we have a way to go with gender diversity in both communities.
