...
# custom version of a  function from the installr package
...
# Rcpp package is categorized as C, not R, langauge so get it manually.
  # line below not working so I load pre-fetched data
  # rcpp_contrib <- get_contrib_info("Rcpp",language="c")
  load("data/contrib_info_rcpp.rdata")
