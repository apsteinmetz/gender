...
Use the full name to get contributors.

Contributor url: https://api.github.com/repos/tidyverse/dplyr/contributors

This JSON object will not contain the "real" names but the links to user profiles.  We make yet another call to the API to extract the real names.  Note some people use pseudonyms.

Calling "https://api.github.com/users/romainfrancois",
